...
public class ExcelUtil {
     ...
     * @功能：手工构建一个简单格式的Excel
     */
    public static void createExcel(Map<String, ArrayList<String>> map, String[] strArray) {
        ...
        for (String str : map.keySet()) {
            ...
            // 第六步，将文件存到指定位置
            try {
                FileOutputStream fout = new FileOutputStream("C:/Users/HaiRui/Desktop/Members.xls");
                wb.write(fout);
                fout.close();
            } catch (Exception e) {
                e.printStackTrace();
